...
export default async function ProfileEditPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-semibold mb-6">แก้ไขประวัติ</h1>
      <form action={updateProfile} className="space-y-6">

        {/* ข้อมูลส่วนตัว */}
        <section className="glass-panel p-5 rounded-xl space-y-4">
          <h2 className="text-sm font-medium text-gray-400 uppercase tracking-wide">ข้อมูลส่วนตัว</h2>
          ...
          <div>
            <label className="text-xs text-gray-500 mb-1 block">ที่อยู่ปัจจุบัน</label>
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div>
              <label className="text-xs text-gray-500 mb-1 block">อำเภอ *</label>
        ...
        {/* ตำแหน่งที่ต้องการ */}
        <section className="glass-panel p-5 rounded-xl space-y-4">
          <h2 className="text-sm font-medium text-gray-400 uppercase tracking-wide">ตำแหน่งงานที่ต้องการ</h2>
          <div className="grid grid-cols-2 gap-3">
            <div>
            ...
            <div>
              <label className="text-xs text-gray-500 mb-1 block">เงินเดือนที่ต้องการ (บาท)</label>
              <input name="desired_salary" type="number" defaultValue={d.desired_salary || ""} className="input-field" />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs text-gray-500 mb-1 block">ประเภทการจ้างงาน</label>
            ...
            <div>
              <label className="text-xs text-gray-500 mb-1 block">วันที่สามารถเริ่มงานได้</label>
        ...
        {/* การศึกษา */}
        <section className="glass-panel p-5 rounded-xl space-y-4">
          <h2 className="text-sm font-medium text-gray-400 uppercase tracking-wide">การศึกษา</h2>
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs text-gray-500 mb-1 block">สถานภาพ</label>
            ...
            <div>
              ...
              <select name="education_level" defaultValue={d.education_level || ""} className="input-field">
                <option value="">เลือก</option>
                <option value="below_high_school">ต่ำกว่ามัธยมศึกษา</option>
          ...
          <div>
            <label className="text-xs text-gray-500 mb-1 block">สถาบันการศึกษา</label>
            <input name="institution" defaultValue={d.institution || ""} className="input-field" />
          </div>
          <div>
            <label className="text-xs text-gray-500 mb-1 block">สาขาวิชา</label>
        ...
        {/* ประสบการณ์ */}
        <section className="glass-panel p-5 rounded-xl space-y-4">
          <h2 className="text-sm font-medium text-gray-400 uppercase tracking-wide">ประสบการณ์ทำงาน</h2>
          <div>
            <label className="text-xs text-gray-500 mb-1 block">ชื่อบริษัท</label>
        ...
        {/* ทักษะ */}
        <section className="glass-panel p-5 rounded-xl space-y-4">
          <h2 className="text-sm font-medium text-gray-400 uppercase tracking-wide">ทักษะและความสามารถ</h2>
          <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            <label className="text-xs text-gray-500 mb-1 block">โครงการ / ผลงาน / ลิงก์ Portfolio</label>
            <textarea name="portfolio" defaultValue={d.portfolio || ""} rows={3} className="input-field" />
          </div>
        </section>

        <button type="submit" className="w-full p-3 bg-[var(--color-primary)] text-white rounded-xl text-sm font-medium hover:bg-[var(--color-primary-hover)] transition-colors">
          บันทึกข้อมูลทั้งหมด
        </button>
      </form>
    </div>
